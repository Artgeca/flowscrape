...
const DesktopSidebar = () => {
  ...
  return (
    <div className='relative hidden h-screen w-full max-w-[280px] border-separate overflow-hidden border-r-2 bg-primary/5 text-muted-foreground dark:bg-secondary/30 dark:text-foreground md:block'>
